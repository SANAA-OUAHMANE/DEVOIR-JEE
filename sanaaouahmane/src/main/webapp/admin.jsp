...
if(p==null){
	response.sendRedirect("http://localhost:8080/sanaaouahmane/authentification");
                    ...
                    <div class="pcoded-content">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="inscription" method="post">
                                                            <div class="form-group row">
                                                             ...
                                                             <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">anneé_edition</label>
                                                                <div class="col-sm-10">
                                                                    <input type="password" name="mdp" class="form-control">
                                                                </div>
                                                            </div>
                        ...
                        <div class="card">
                                            ...
                                            <div class="card-block table-border-style">
                                                ...
                                                <% ArrayList<Livre> livres = services.serviceLivre.listeLivres(); %>
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
